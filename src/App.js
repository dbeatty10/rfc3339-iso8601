...
function App ({ initialDate = null, initalShowISO = true, initalShowRFC = true, initalShowHTML = true, initalShowColours = true, readOnlyMode = false, showDiagram = true, initialShowSixDigitYears = false }) {
